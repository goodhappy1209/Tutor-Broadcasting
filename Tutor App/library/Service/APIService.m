    ...
    [manager POST:fullUrl parameters:nil constructingBodyWithBlock:^(id<AFMultipartFormData> formData) {
        for (NSString *key in [queryParams allKeys]) {
            ...
            if ([obj isKindOfClass:[NSData class]]) {
                ...
                [formData appendPartWithFileData:(NSData*)obj name:key fileName:[NSString stringWithFormat:@"%@.png", [queryParams objectForKey:account_member_id]] mimeType:@"image/png"];
