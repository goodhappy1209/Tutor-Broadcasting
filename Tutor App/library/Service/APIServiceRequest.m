...
//    if (self.type == RequestTypeFromData) {
//        
//        [req setValue:[NSString stringWithFormat:@"%d", self.queryParams] forHTTPHeaderField:@"Content-Length"];
...
//                                            NSLog(@"Response String : %@", [[NSString alloc] initWithData:data encoding:NSASCIIStringEncoding]);

                                            NSDictionary *parsedResponse = (NSDictionary *)[NSJSONSerialization JSONObjectWithData:data
                                                                                                           options:NSJSONReadingAllowFragments
                                                                                                             error:&parseError];
                                            NSLog(@"Response Value : %@", parsedResponse);
