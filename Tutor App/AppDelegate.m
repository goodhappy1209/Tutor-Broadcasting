...
const NSUInteger kQBApplicationID = 28433;
NSString *const kQBRegisterServiceKey = @"uZORawuyXrEevj7";
NSString *const kQBRegisterServiceSecret = @"AUX7n9nLfKeqxae";
NSString *const kQBAccountKey = @"uMbYXRHkmGSdgveDraJE";
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "Totor.Tutor_App" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Tutor_App" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Tutor_App.sqlite"];
    NSError *error = nil;
