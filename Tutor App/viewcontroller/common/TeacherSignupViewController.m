...
#import "TeacherSignupViewController.h"

@interface TeacherSignupViewController ()
{
...
@implementation TeacherSignupViewController
@synthesize titleTextField, first_nameTextField, last_nameTextField, emailTextField, passwordTextField, phoneTextField, birthdayTextField, cityTextField, countryTextField, universityTextField, courseTextField, subjectTextField;
...
- (IBAction)onSignUp:(id)sender
{
    ...
    NSDictionary *param = @{
                            ...
                            account_type : account_tutor,
                            account_title_tutor : titleTextField.text,
                            ...
                            account_university_tutor : universityTextField.text,
                            account_course_tutor : courseTextField.text,
