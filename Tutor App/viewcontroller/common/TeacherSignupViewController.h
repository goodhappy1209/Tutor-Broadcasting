...
@interface TeacherSignupViewController : UIViewController<UITextFieldDelegate, UIAlertViewDelegate, MONPromptViewDelegate>
...
@property (nonatomic ,assign) IBOutlet UITextField *universityTextField;
@property (nonatomic ,assign) IBOutlet UITextField *courseTextField;
